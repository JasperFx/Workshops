...
builder.Services.AddMarten(opts =>
    ...
    {
        // Option #1: forward events captured in Marten to Wolverine post haste,
        // but without any strict ordering
        ...
        x.SubscribeToEvent<IncidentCategorised>().TransformedTo(e => new TryAssignPriority
        {
    ...
    // Option #2: Publish the events to Wolverine in strict order
...
{
    // Automatically wrap handlers with transactional middleware
...
app.MapPost("/api/incidents", (CategoriseIncident command, IMessageBus bus) => bus.InvokeAsync(command));
