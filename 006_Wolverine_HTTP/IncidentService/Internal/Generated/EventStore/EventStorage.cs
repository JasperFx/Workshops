...
namespace Marten.Generated.EventStore
{
    ...
    public sealed class GeneratedEventDocumentStorage : Marten.Events.EventDocumentStorage
    {
        ...
        public override Marten.Linq.QueryHandlers.IQueryHandler<Marten.Events.StreamState> QueryForStream(JasperFx.Events.StreamAction stream)
        {
    ...
    public sealed class AppendEventOperation : Marten.Events.Operations.AppendEventOperationBase
    {
        ...
        {
            builder.Append("insert into public.mt_events (data, type, mt_dotnet_type, id, stream_id, version, timestamp, tenant_id, correlation_id, causation_id, seq_id) values (");
            ...
            var parameter8 = Event.CorrelationId != null ? parameterBuilder.AppendParameter(Event.CorrelationId) : parameterBuilder.AppendParameter<object>(System.DBNull.Value);
            parameter8.NpgsqlDbType = NpgsqlTypes.NpgsqlDbType.Text;
            var parameter9 = Event.CausationId != null ? parameterBuilder.AppendParameter(Event.CausationId) : parameterBuilder.AppendParameter<object>(System.DBNull.Value);
            parameter9.NpgsqlDbType = NpgsqlTypes.NpgsqlDbType.Text;
            var parameter10 = parameterBuilder.AppendParameter(Event.Sequence);
            parameter10.NpgsqlDbType = NpgsqlTypes.NpgsqlDbType.Bigint;
            builder.Append(')');
        }
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class AppendEventOperationQuickWithVersion : Marten.Events.Operations.AppendEventOperationBase
    {
        private readonly JasperFx.Events.StreamAction _stream;
        private readonly JasperFx.Events.IEvent _e;

        public AppendEventOperationQuickWithVersion(JasperFx.Events.StreamAction stream, JasperFx.Events.IEvent e) : base(stream, e)
        {
            _stream = stream;
            _e = e;
        }
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class QuickAppendEventsOperation : Marten.Events.Operations.QuickAppendEventsOperationBase
    {
        private readonly JasperFx.Events.StreamAction _stream;

        public QuickAppendEventsOperation(JasperFx.Events.StreamAction stream) : base(stream)
        {
            _stream = stream;
        }
        ...
        public override void ConfigureCommand(Weasel.Postgresql.ICommandBuilder builder, Marten.Internal.IMartenSession session)
        {
            ...
            writeCausationIds(parameterBuilder);
            writeCorrelationIds(parameterBuilder);
            builder.Append(')');
        }
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GeneratedInsertStream : Marten.Events.Operations.InsertStreamBase
    {
        private readonly JasperFx.Events.StreamAction _stream;

        public GeneratedInsertStream(JasperFx.Events.StreamAction stream) : base(stream)
        {
            _stream = stream;
        }
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GeneratedStreamStateQueryHandler : Marten.Events.Querying.StreamStateQueryHandler
    {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GeneratedStreamVersionOperation : Marten.Events.Operations.UpdateStreamVersion
    {
        private readonly JasperFx.Events.StreamAction _stream;

        public GeneratedStreamVersionOperation(JasperFx.Events.StreamAction stream) : base(stream)
        {
            _stream = stream;
        }
